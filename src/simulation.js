...
const drops = Emitter.createDropCube(Vec3.create(0, 1, 0), 8, 12, 8, PARTICLE_RADIUS*2)
...
function update(){ 
    ...
    // SPH: density (rho) at particle positions
    for(let di of drops){
        di.rho = 0
        for(let dj of drops){
